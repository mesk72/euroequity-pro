...
const FEEDS: Record<Region, { name: string; url: string }[]> = {
  ...
  americas: [
    ...
    { name: 'Motley Fool', url: 'https://www.fool.com/feeds/index.aspx' },
    { name: 'Google US Mkts', url: 'https://news.google.com/rss/search?q=stock+market+earnings+S%26P500+nasdaq+Wall+Street&hl=en&gl=US&ceid=US:en' },
  ...
  europe: [
    ...
    { name: 'Google DAX', url: 'https://news.google.com/rss/search?q=DAX+FTSE+CAC+eurostoxx+ECB+earnings+Europe&hl=en&gl=US&ceid=US:en' },
    { name: 'Google Italy', url: 'https://news.google.com/rss/search?q=borsa+Milano+MIB+azioni+mercati&hl=it&gl=IT&ceid=IT:it' },
  ],
  asia: [
    { name: 'Yahoo Finance', url: 'https://finance.yahoo.com/rss/topstories' },
    { name: 'SCMP Markets', url: 'https://www.scmp.com/rss/92/feed' },
    { name: 'Japan Times Biz', url: 'https://www.japantimes.co.jp/feed/business/' },
    { name: 'Google Nikkei', url: 'https://news.google.com/rss/search?q=nikkei+hangseng+ASX+stocks+earnings+asia+BOJ&hl=en&gl=US&ceid=US:en' },
    { name: 'Google China', url: 'https://news.google.com/rss/search?q=china+stocks+economy+yuan+CSI300&hl=en&gl=US&ceid=US:en' },
  ],
}
