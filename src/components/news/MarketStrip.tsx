...
export default function MarketStrip() {
  ...
  useEffect(() => {
    ...
    script.innerHTML = JSON.stringify({
      symbols: [
        { proName: 'FOREXCOM:SPXUSD',  title: 'S&P 500 (prev.close)' },
        { proName: 'FOREXCOM:NSXUSD',  title: 'Nasdaq 100 (prev.close)' },
        { proName: 'FOREXCOM:DJI',     title: 'Dow Jones (prev.close)' },
        ...
        { proName: 'INDEX:SXXP',       title: 'Stoxx 600 (prev.close)' },
  ...
  return (
    <div style={{ borderBottom: '1px solid var(--border)', marginBottom: 4 }}>
      ...
      <div style={{ fontSize: 9, color: 'var(--text4)', padding: '2px 8px 4px', textAlign: 'right' }}>
        Prices powered by TradingView · S&P 500, Nasdaq, Dow, Stoxx 600 = previous close · FTSE 100 = future · DAX/CAC/MIB/Nikkei/HSI/ASX = real-time · delayed 15-20 min
      </div>
    </div>
  )
}
