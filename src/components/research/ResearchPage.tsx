...
const NOTES: ResearchNote[] = [
  ...
  },
  {
    ...
    title: 'The Electrification Compounder — Best-in-Class Growth',
    subtitle: 'Value 17 vs Growth 85 · EPS CAGR +38.8% · ROIC 15.4%',
    date: 'June 2026',
    sector: 'Industrials',
    tags: ['Top Growth', 'Electrification', 'EPS CAGR 38.8%', 'Cables'],
    summary: 'PRY scores Growth 85/100. 2026E EPS +59.2% YoY, Fwd 2-Yr EPS CAGR +38.8%, +157.7% 12M return. LTM ROIC 15.4%, ROE 22.7%. Net Debt/EBITDA compressing to 0.91x. Expensive at 29.77x NTM P/E but exceptional business dominating the energy transition mega-trend.',
  ...
  },
  {
    ...
    exchange: 'SWX',
    company: 'ABB Ltd',
    title: 'The Ultimate Industrial Growth Engine',
    subtitle: 'Value 17 vs Growth 82 · ROE 33.6% · ROIC 24.5%',
    date: 'June 2026',
    sector: 'Industrials',
    tags: ['Top Growth', 'Automation', 'Electrification', 'ROE 33.6%'],
    summary: 'ABBN scores Growth 82/100. Revenue CAGR accelerating from 4.1% to +10.5% forward. 2026E EBITDA +19.5%, EPS +20.8% YoY. LTM ROE 33.6%, ROIC 24.5%, Net Debt/EBITDA 0.44x. +79.7% 12M return. Premium 32.35x NTM P/E justified by elite capital efficiency.',
  ...
  },
  {
    ...
    exchange: 'LSE',
    company: 'Shell plc',
    title: 'The Best GARP Play in European Energy',
    subtitle: 'Value 66 · Growth 71 · EPS +72.9% YoY · NTM P/E 7.93x',
    date: 'June 2026',
    sector: 'Energy',
    tags: ['GARP', 'Top 20%', 'EPS +72.9%', 'Dividend 3.7%'],
    summary: 'SHEL scores Value 66/100 and Growth 71/100. NTM P/E 7.93x with 2026E EPS +72.9% YoY and Fwd 2-Yr EPS CAGR +23.8%. LTM ROIC 11.7%, FCF margin 9.5%, Net Debt/EBITDA compressing to 0.58x. Tech-like EPS growth at single-digit multiples plus 3.7% dividend.',
  ...
  },
  {
    ...
    title: 'Growth Disconnection Alert — Premium Multiples vs Stalling Fundamentals',
    subtitle: 'Value 36 · Growth 28 · Revenue +0.2% · NTM P/E 20.51x',
    date: 'June 2026',
    sector: 'Consumer Discretionary',
    tags: ['Growth Trap', 'Watchlist', 'Value 36', 'EBITDA -4.2%'],
    summary: 'MC scores Value 36/100 and Growth 28/100. 2026E Revenue +0.2% YoY after -4.6% in 2025. Normalized EPS +1.6% YoY. EBITDA -4.2%. Trading at 20.51x NTM P/E — PEG above 2.0x. Quality metrics intact but acting as shock absorbers, not growth engines.',
