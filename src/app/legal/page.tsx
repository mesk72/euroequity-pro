export default function LegalPage() {
  const sections = [
    ...
    },
    {
      ...
      items: [
        ['Not Investment Advice', 'EuroEquity Pro is a personal financial data and research tool operated by Andrea Meschini as an individual. All data, analytics, and tools are provided for informational and educational purposes only. Nothing on this platform constitutes investment advice, financial advice, or a personal recommendation to buy, sell, or hold any financial instrument within the meaning of D.Lgs. 58/1998 (TUF), MiFID II (Directive 2014/65/EU), or any other applicable regulation.'],
        ['Not Authorised to Advise', 'Andrea Meschini has passed the CFA Program Level III examination and the IMC (Investment Management Certificate) examination and has extensive professional experience in investment management. However, he is not currently registered as an authorised financial advisor (consulente finanziario abilitato all\'offerta fuori sede) with the OCF (Organismo di vigilanza e tenuta dell\'albo unico dei Consulenti Finanziari), nor with the FCA or any other regulatory authority. EuroEquity Pro does not provide regulated investment services.'],
        ['No Offer or Solicitation', 'Nothing on EuroEquity Pro constitutes an offer or solicitation to buy or sell any financial instrument in any jurisdiction. Past performance is not indicative of future results.'],
    ...
    },
    {
      ...
      items: [
        ['Proprietary Content', 'All quantitative models (Value Score, Growth Score), ranking algorithms, software, design, and original text content on EuroEquity Pro are the intellectual property of Andrea Meschini, protected by Italian copyright law (L. 633/1941) and applicable EU intellectual property law.'],
    ...
    },
    {
      ...
      items: [
        ['Strictly Necessary Cookies', 'EuroEquity Pro uses only strictly necessary cookies for session management and security (CSRF protection). These do not require your consent under Art. 122 D.Lgs. 196/2003 and cannot be disabled without affecting service functionality.'],
        ['No Advertising or Tracking', 'EuroEquity Pro does not use advertising cookies, third-party tracking cookies, or analytics cookies. No data is shared with advertising or analytics networks.'],
