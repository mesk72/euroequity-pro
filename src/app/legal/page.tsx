  ...
  const sections = [
    {
      ...
      items: [
        ...
        ['Access, Suspension and Termination', 'Access to ForwardAlpha is granted at the sole discretion of the operator. As the service is provided free of charge, the operator may suspend, restrict or terminate any account, and may modify, limit or discontinue the service in whole or in part, at any time and without prior notice or stated reason. No warranty of continued availability, uptime or uninterrupted access is given. Users may close their account at any time by written request. Upon termination, personal data are handled in accordance with the Privacy Policy set out in Section 5.'],
    ...
    },
    {
      ...
      items: [
        ...
        ['Data Accuracy & Updates', 'Prices are updated daily following the close of each market. Fundamental data are updated periodically. See Section 6 for the applicable warranty and liability terms relating to data accuracy.'],
    ...
    },
    {
      ...
      items: [
        ...
        ['No Guarantee of Accuracy', 'Data are obtained from third-party providers and may contain errors, omissions or delays. The full warranty terms are set out in Section 6.'],
    ...
    {
      title: '6. Use of Artificial Intelligence and Editorial Responsibility',
      items: [
