  ...
  const sections = [
    ...
    },
    {
      ...
      items: [
        ...
        ['Data Accuracy & Updates', 'Prices tend to be updated daily (we are currently experiencing some technical issues affecting update reliability). Fundamental data (P/E, EPS, dividends, etc.) is updated weekly. Andrea Meschini makes no warranty as to accuracy, completeness, timeliness, or fitness for purpose of any data displayed.'],
