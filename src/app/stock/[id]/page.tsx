          ...
          return (
            <div style={{ background:'var(--surface)', border:'1px solid var(--border)',
              ...
              <div style={{ display:'flex', gap:8, flexWrap:'wrap' }}>
                ...
                {(stock as any).yahoo_ticker && <a href={`https://finance.yahoo.com/quote/${(stock as any).yahoo_ticker}/analysis/`} target="_blank" rel="noopener noreferrer" style={{ background:'#6b21a8', color:'#fff', fontFamily:'IBM Plex Sans Condensed', fontSize:11, fontWeight:700, padding:'6px 12px', borderRadius:3, textDecoration:'none' }}>📊 Estimates</a>}
              </div>
            </div>
          )
        })()}
