...
print()
print("=== Yahoo ha il 6/8 per Milano/Parigi/Francoforte ADESSO? ===")
for yt in ["ISP.MI","ENI.MI","MC.PA","OR.PA","SAP.DE","BMW.DE"]:
    try:
        ...
        print("  %-8s errore" % yt)
print()
print("=== log EU: cosa dice sul download principale ===")
...
for riga in r[0]["log_text"].split("\n"):
    if any(k in riga for k in ["Prezzi Yahoo","BLOCCO","Data piu' recente","MIL","PA:","XETRA"]):
        print("  ",riga.strip()[:120])
