...
def enrich_df(df, max_enrich=None):
    ...
    mom_12_1 = pd.to_numeric(df["Mom 12M %"], errors="coerce") - pd.to_numeric(df["Mom 1M %"], errors="coerce")
mom_6_1w = pd.to_numeric(df["Mom 6M %"],  errors="coerce") - pd.to_numeric(df["Mom 1W %"], errors="coerce")
