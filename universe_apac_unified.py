...
for exchange, criteria in EXCHANGE_CRITERIA.items():
    ...
    # aggiorna solo righe gia' esistenti, lasciando senza mkt_cap i
    # titoli appena entrati in universo che non hanno ancora una riga
    # in fundamentals (creata di solito da weekly_apac.py)
