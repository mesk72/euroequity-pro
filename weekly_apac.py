...
try:
    ...
    for row in reader:
        ...
        raw_rows.append({
            ...
            "eps_fy0": parse_num(row.get("EPS (GAAP) (FY 2025)","") if exchange == "TSE" else row.get("EPS Normalized (FY 2025)","")),
            "eps_fy1": parse_num(row.get("Mean EPS (GAAP) (FY 2026)","") if exchange == "TSE" else row.get("Mean EPS Normalized (FY 2026)","")),
            "eps_fy2": parse_num(row.get("Mean EPS (GAAP) (FY 2027)","") if exchange == "TSE" else row.get("Mean EPS Normalized (FY 2027)","")),
            "eps_fy3": parse_num(row.get("Mean EPS (GAAP) (FY 2028)","") if exchange == "TSE" else row.get("Mean EPS Normalized (FY 2028)","")),
