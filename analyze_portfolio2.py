...
print(f"\n=== MEDIE PESATE (normalizzate come se il sotto-portafoglio coperto fosse il 100%) ===")
if wv is not None: print(f"Value Score medio: {wv:.1f}")
if wg is not None: print(f"Growth Score medio: {wg:.1f}")
if wb is not None: print(f"Best Score medio: {wb:.1f}")
