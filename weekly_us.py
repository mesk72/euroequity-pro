...
# Mappa i nomi mercato di TIKR (usati SOLO in questo file) ai nostri codici
# interni. L'Europa in questo file usa gia' i nostri codici (MC, MIL, ecc.)
# quindi non serve toccarli; servono solo per USA (spezzato in piu' sotto-
# mercati) e alcuni mercati asiatici con nome diverso.
